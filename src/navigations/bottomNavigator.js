    ...
    >
      <Bottom.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) =>
            focused ? (
              <HomeAc width={28} height={28} />
            ) : (
              <HomeInac width={28} height={28} />
            ),
        }}
      />
      <Bottom.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) =>
            focused ? (
              <CalendarAc width={28} height={28} />
            ) : (
              <CalendarInac width={28} height={28} />
            ),
        }}
      />
      <Bottom.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) =>
            focused ? (
              <TaskAc width={28} height={28} />
            ) : (
              <TaskInac width={28} height={28} />
            ),
        }}
      />
      <Bottom.Screen
      ...
      <Bottom.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) =>
            focused ? (
              <LeaveAc width={28} height={28} />
            ) : (
              <LeaveInac width={28} height={28} />
            ),
        }}
      />
    </Bottom.Navigator>
